...
import type { AuditContractorActivitiesInput, AuditContractorActivitiesOutput } from '@/types/server-only';
import { runAudit } from '@/ai/flows/audit-contractor-activities-flow'; 
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const result: AuditContractorActivitiesOutput = await runAudit(requestBody); 
