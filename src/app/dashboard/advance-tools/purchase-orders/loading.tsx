...
export default function PurchaseOrdersLoadingSkeleton() {
  return (
      ...
      <Card className="shadow-lg">
        ...
        <CardContent>
          ...
          <div className="md:hidden space-y-4">
            {[...Array(3)].map((_, i) => (
              <Card key={`skel-card-po-mobile-${i}`} className="shadow-md">
                <CardHeader>
                ...
                <CardFooter className="flex justify-end space-x-1 pt-2">
                  {[...Array(4)].map((_, j) => <Skeleton key={j} className="h-8 w-16 rounded" />)}
                </CardFooter>
              </Card>
            ))}
          </div>
          ...
          <div className="hidden md:block">
            <div className="overflow-x-auto">
              <Table>
                ...
                <TableBody>
                  {[...Array(3)].map((_, i) => (
                    <TableRow key={`skel-row-po-desktop-${i}`}>
