...
import { ArrowLeft, Receipt, Edit, Download, Loader2, AlertTriangle, Link as LinkIconOriginal, FileText, DownloadCloud, UploadCloud, ClipboardList, PieChart, Banknote } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2 w-full sm:w-auto">
           <Button onClick={() => setIsSdAnalyzerModalOpen(true)} variant="outline" className="flex-grow sm:flex-grow-0">
             <PieChart className="mr-2 h-4 w-4" />SD Analyzer
          </Button>
          <Button onClick={() => setIsInvoiceStatusModalOpen(true)} variant="outline" className="flex-grow sm:flex-grow-0">
